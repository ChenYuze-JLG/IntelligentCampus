...
//        System.out.println(endDate);
        ExamQueryForStudentMap examQueryForStudentMap = new ExamQueryForStudentMap(studentID, startDate, endDate);
        return examQueryMapper.getExamSchedule(examQueryForStudentMap);
    }
}
