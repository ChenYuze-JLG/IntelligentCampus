...
//        System.out.println(endDate);
        ScoreQueryForStudentMap scoreQueryForStudentMap = new ScoreQueryForStudentMap(studentID,startDate,endDate);
        return scoreMapper.getScore(scoreQueryForStudentMap);
    }
